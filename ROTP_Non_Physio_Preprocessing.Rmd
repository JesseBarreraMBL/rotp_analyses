...
non_physio_merged_raw <- non_physio_merged_raw %>%
  mutate(across(c(stress_mindset_1_t5_non_physio:stress_mindset_4_t5_non_physio), ~.-1))

# T7

non_physio_merged_raw <- non_physio_merged_raw %>%
  mutate(across(c(stress_mindset_1_t7_non_physio:stress_mindset_4_t7_non_physio), ~.-1))

# T8

non_physio_merged_raw <- non_physio_merged_raw %>%
  mutate(across(c(stress_mindset_1_t8_non_physio:stress_mindset_4_t8_non_physio), ~.-1))
...
non_physio_merged_raw[ ,'stress_mindset_1_t5_non_physio'] <- 4 - non_physio_merged_raw[ ,'stress_mindset_1_t5_non_physio']
non_physio_merged_raw[ ,'stress_mindset_3_t5_non_physio'] <- 4 - non_physio_merged_raw[ ,'stress_mindset_3_t5_non_physio']

# T7

non_physio_merged_raw[ ,'stress_mindset_1_t7_non_physio'] <- 4 - non_physio_merged_raw[ ,'stress_mindset_1_t7_non_physio']
non_physio_merged_raw[ ,'stress_mindset_3_t7_non_physio'] <- 4 - non_physio_merged_raw[ ,'stress_mindset_3_t7_non_physio']

#T7

non_physio_merged_raw[ ,'stress_mindset_1_t8_non_physio'] <- 4 - non_physio_merged_raw[ ,'stress_mindset_1_t8_non_physio']
non_physio_merged_raw[ ,'stress_mindset_3_t8_non_physio'] <- 4 - non_physio_merged_raw[ ,'stress_mindset_3_t8_non_physio']
...
non_physio_merged_raw <- non_physio_merged_raw %>%
  mutate(stress_mindset_t5_non_physio = rowMeans(select(.,stress_mindset_1_t5_non_physio:stress_mindset_4_t5_non_physio)))

stress_mindset_t5_non_physio_df <- non_physio_merged_raw %>%
  select(stress_mindset_1_t5_non_physio:stress_mindset_4_t5_non_physio)

psych::alpha(stress_mindset_t5_non_physio_df)

# T7

non_physio_merged_raw <- non_physio_merged_raw %>%
  mutate(stress_mindset_t7_non_physio = rowMeans(select(.,stress_mindset_1_t7_non_physio:stress_mindset_4_t7_non_physio)))

stress_mindset_t7_non_physio_df <- non_physio_merged_raw %>%
  select(stress_mindset_1_t7_non_physio:stress_mindset_4_t7_non_physio)

psych::alpha(stress_mindset_t7_non_physio_df)

# T8

non_physio_merged_raw <- non_physio_merged_raw %>%
  mutate(stress_mindset_t8_non_physio = rowMeans(select(.,stress_mindset_1_t8_non_physio:stress_mindset_4_t8_non_physio)))

stress_mindset_t8_non_physio_df <- non_physio_merged_raw %>%
  select(stress_mindset_1_t8_non_physio:stress_mindset_4_t8_non_physio)

psych::alpha(stress_mindset_t8_non_physio_df)
...
non_physio_merged_raw <- non_physio_merged_raw %>%
  mutate(growth_mindset_t5_non_physio = rowMeans(select(.,growth_mindset_1_t5_non_physio:growth_mindset_3_t5_non_physio)))

growth_mindset_t5_non_physio_df <- non_physio_merged_raw %>%
  select(growth_mindset_1_t5_non_physio:growth_mindset_3_t5_non_physio)

psych::alpha(growth_mindset_t5_non_physio_df)

# T7

non_physio_merged_raw <- non_physio_merged_raw %>%
  mutate(growth_mindset_t7_non_physio = rowMeans(select(.,growth_mindset_1_t7_non_physio:growth_mindset_3_t7_non_physio)))

growth_mindset_t7_non_physio_df <- non_physio_merged_raw %>%
  select(growth_mindset_1_t7_non_physio:growth_mindset_3_t7_non_physio)

psych::alpha(growth_mindset_t7_non_physio_df)

# T8

non_physio_merged_raw <- non_physio_merged_raw %>%
  mutate(growth_mindset_t8_non_physio = rowMeans(select(.,growth_mindset_1_t8_non_physio:growth_mindset_3_t8_non_physio)))

growth_mindset_t8_non_physio_df <- non_physio_merged_raw %>%
  select(growth_mindset_1_t8_non_physio:growth_mindset_3_t8_non_physio)

psych::alpha(growth_mindset_t8_non_physio_df)
