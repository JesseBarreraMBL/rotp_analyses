...
non_physio_merged_raw <- non_physio_merged_raw %>% 
  select(-c(Status_t5_non_physio, Progress_t5_non_physio, EndDate_t5_non_physio, LocationLatitude_t5_non_physio, 
         LocationLongitude_t5_non_physio, Status_t6_non_physio, Progress_t6_non_physio, EndDate_t6_non_physio,
         ...
         Status_t7_non_physio, Progress_t7_non_physio, EndDate_t7_non_physio, LocationLatitude_t7_non_physio, LocationLongitude_t7_non_physio, Status_t8_non_physio, Progress_t8_non_physio, EndDate_t8_non_physio, LocationLatitude_t8_non_physio, LocationLongitude_t8_non_physio))
...
non_physio_summaries_raw <- non_physio_merged_raw %>% 
  select(StartDate_t5_non_physio, RecipientEmail:vax_status_free_t5_non_physio, religion_non_physio:religion_free_t5_non_physio,
         condition, StartDate_t6_non_physio, StartDate_t7_non_physio, cov_sym_t7_non_physio:COVID.Status_t7_non_physio, 
         StartDate_t8_non_physio, prh_routine_t8_non_physio:COVID.Vaccine.Statu_t8_non_physio, durability_1_t8_non_physio:durability_free_t8_non_physio, extraversion_t8_non_physio:dependability_t8_non_physio,
